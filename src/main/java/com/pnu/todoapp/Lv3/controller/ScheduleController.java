package com.pnu.todoapp.Lv3.controller;

import com.pnu.todoapp.Lv3.dto.RequestCreateScheduleDto;
import com.pnu.todoapp.Lv3.dto.RequestDeleteScheduleDto;
import com.pnu.todoapp.Lv3.dto.RequestUpdateScheduleDto;
import com.pnu.todoapp.Lv3.dto.ResponseScheduleDto;
import com.pnu.todoapp.Lv3.service.ScheduleService;
...
public class ScheduleController {
    ...
    @GetMapping
    public ResponseEntity<List<ResponseScheduleDto>> getManySchedules(@RequestParam(required = false) String username, @RequestParam(required = false) String updatedAt) {
